...
class ApiControllerTest extends WebTestCase
{
    ...
    public function setUp()
    {
        ...
        $loader->loadFromDirectory(static::$kernel->locateResource('@JobeetBundle/DataFixtures/ORM'));
    ...
    public function testList()
    {
        ...
        $this->assertEquals('Epfc\JobeetBundle\Controller\ApiController::listAction', $client->getRequest()->attributes->get('_controller'));
        $this->assertTrue($crawler->filter('description')->count() == 0); // =32
