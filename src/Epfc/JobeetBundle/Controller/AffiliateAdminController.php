...
class AffiliateAdminController extends Controller
{
     ...
     */
    public function batchActionActivate(ProxyQueryInterface $selectedModelQuery, Request $request)
    {
    ...
    public function batchActionDeactivate(ProxyQueryInterface $selectedModelQuery, Request $request)
    {
        if($this->admin->isGranted('EDIT') === false || $this->admin->isGranted('DELETE') === false) {
            throw new AccessDeniedException();
        }
    ...
    public function activateAction($id)
    {
        ...
        $affiliate = $em->getRepository('JobeetBundle:Affiliate')->findOneById($id);
