<?php
namespace  Epfc\JobeetBundle\DataFixtures\ORM;
...
class LoadAffiliateData extends AbstractFixture implements OrderedFixtureInterface
{
  public function load(ObjectManager $em)
  {
    ...
    $affiliate->setCategory($em->merge($this->getReference('category-programming')), $em->merge($this->getReference('category-design')));
